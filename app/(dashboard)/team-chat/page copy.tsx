...
export default function TeamChatPage() {
    ...
    const handleSelectChannel = (id: string, name: string) => {
        ...
        if (id) {
            ...
            // Clear unread count locally for this channel
            setChannels((prev) =>
    ...
    // ============================================================
    // SOCKET LISTENERS - REAL-TIME UPDATES ACROSS WHOLE APP
    // ============================================================
    useEffect(() => {
        if (!socket) return;

        // 🔥 1. When ANY message arrives: update sidebar snippet, count & move channel to top
        const handleGlobalNewMessage = (data: { channelId: string; message: any }) => {
            setChannels((prev) => {
                ...
                // Re-sort: bump newest message channel to top
        ...
        // 🔥 2. When current user is added to a brand new channel/DM
