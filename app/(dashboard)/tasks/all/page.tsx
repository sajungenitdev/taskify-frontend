...
export default function TaskBoardPage() {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col overflow-hidden">
      ...
      <div className="flex-shrink-0 p-4 lg:p-6 space-y-4 border-b border-slate-800/50">
        {/* Title and Actions */}
        ...
        <div className="flex-1 min-h-0 p-4 lg:p-6 pt-2">
          ...
          >
            ...
            <DragOverlay dropAnimation={{ duration: 200 }}>
              {activeId ? (
                <div className="bg-gradient-to-br from-indigo-800 to-indigo-900 rounded-lg p-3 border-2 border-indigo-500 shadow-2xl w-[320px] opacity-95">
                  {(() => {
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-indigo-700/50">
                          ...
                          {task.deadline && (
                            <div className="flex items-center gap-0.5">
                              <Calendar size={8} className="text-indigo-300" />
...
function DroppableColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      className={`flex-shrink-0 w-[340px] h-full flex flex-col bg-slate-900/40 rounded-xl border border-slate-800 backdrop-blur-sm transition-all duration-200 ${
        activeId ? "ring-1 ring-indigo-500/50" : ""
      }`}
    >
      {/* Column Header */}
      <div
        className={`flex-shrink-0 p-3 border-b border-slate-800 bg-gradient-to-r from-${column.color}-500/10 to-transparent rounded-t-xl`}
      >
...
function TaskCard({
  ...
  return (
    <div
      ...
      className="bg-gradient-to-br from-slate-800 to-slate-900/80 rounded-lg p-3 border border-slate-700 hover:border-indigo-500/50 transition-all cursor-grab active:cursor-grabbing hover:shadow-lg hover:-translate-y-0.5"
    >
      <div className="flex items-center gap-2 mb-2">
        <span
          className={`text-[9px] px-1.5 py-0.5 rounded-full ${getPriorityColor(task.priority)}`}
