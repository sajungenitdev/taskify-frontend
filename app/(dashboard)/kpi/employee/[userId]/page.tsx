...
// WEIGHT CONSTANTS FOR CALCULATION
const WEIGHTS = {
    taskCompletion: 0.25,
    qualityScore: 0.20,
    efficiency: 0.20,
...
export default function EmployeeKPIDetailPage() {
    ...
    // ============================================================
    // EXACT KPI CALCULATION - SAME AS DASHBOARD
    // ============================================================
    const calculateKPIFromTasks = useCallback((
        userData: UserData,
        tasks: ApiTask[],
        allUsers: UserData[]
    ): EmployeeKPI => {
    ...
    const loadAllData = useCallback(async () => {
        ...
        try {
            ...
            // 3. Filter tasks by selected month/year
            ...
            // 5. Calculate KPI from month-filtered tasks
            const kpiData = calculateKPIFromTasks(userData, monthTasks, allUsers);
            setEmployee(kpiData);
            console.log("Calculated KPI from month tasks:", kpiData.totalScore);
    ...
    }, [userId, selectedMonth, selectedYear, calculateKPIFromTasks]);
